...
public class AgentTokenTrackerTest {
    ...
    public void testMergeSubAgentUsage_basic() {
        ...
        subAgentUsage.put("per_turn_usage", List.of(
            Map.of("turn", 1, "model_id", "claude-3", "model_name", "claude-3", "model_url", "https://bedrock", "input_tokens", 100L, "output_tokens", 50L, "total_tokens", 150L),
            Map.of("turn", 2, "model_id", "claude-3", "model_name", "claude-3", "model_url", "https://bedrock", "input_tokens", 200L, "output_tokens", 75L, "total_tokens", 275L)
        ));
        subAgentUsage.put("per_model_usage", List.of(
            Map.of("model_id", "claude-3", "model_name", "claude-3", "model_url", "https://bedrock", "input_tokens", 300L, "output_tokens", 125L, "total_tokens", 425L, "call_count", 2)
        ));
    ...
    public void testMergeSubAgentUsage_afterExistingTurns() {
        ...
        subAgentUsage.put("per_model_usage", List.of(
            Map.of("model_id", "claude-3", "model_name", "claude-3", "model_url", "https://bedrock", "input_tokens", 450L, "output_tokens", 185L, "total_tokens", 635L, "call_count", 3)
        ));
    ...
    public void testMergeSubAgentUsage_sameModel() {
        ...
        Map<String, Object> subAgentUsage = new HashMap<>();
        subAgentUsage.put("per_turn_usage", List.of(
            Map.of("turn", 1, "model_id", "claude-3", "input_tokens", 200L, "output_tokens", 75L, "total_tokens", 275L)
        ));
        subAgentUsage.put("per_model_usage", List.of(
            Map.of("model_id", "claude-3", "model_name", "claude-3", "model_url", "https://bedrock", "input_tokens", 200L, "output_tokens", 75L, "total_tokens", 275L, "call_count", 1)
        ));
    ...
    public void testMergeSubAgentUsage_multipleSteps() {
        ...
        step1Usage.put("per_turn_usage", List.of(
            Map.of("turn", 1, "model_id", "claude-3", "model_name", "claude-3", "model_url", "https://bedrock", "input_tokens", 100L, "output_tokens", 50L, "total_tokens", 150L)
        ));
        step1Usage.put("per_model_usage", List.of(
            Map.of("model_id", "claude-3", "model_name", "claude-3", "model_url", "https://bedrock", "input_tokens", 100L, "output_tokens", 50L, "total_tokens", 150L, "call_count", 1)
        ));
        ...
        step2Usage.put("per_turn_usage", List.of(
            Map.of("turn", 1, "model_id", "claude-3", "model_name", "claude-3", "model_url", "https://bedrock", "input_tokens", 200L, "output_tokens", 75L, "total_tokens", 275L),
            Map.of("turn", 2, "model_id", "claude-3", "model_name", "claude-3", "model_url", "https://bedrock", "input_tokens", 150L, "output_tokens", 60L, "total_tokens", 210L)
        ));
        step2Usage.put("per_model_usage", List.of(
            Map.of("model_id", "claude-3", "model_name", "claude-3", "model_url", "https://bedrock", "input_tokens", 350L, "output_tokens", 135L, "total_tokens", 485L, "call_count", 2)
        ));
