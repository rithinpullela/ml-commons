...
import org.opensearch.ml.common.transport.memorycontainer.memory.MLMemoryGetAction;
import org.opensearch.ml.common.transport.memorycontainer.memory.MLMemoryGetRequest;
import org.opensearch.ml.common.transport.memorycontainer.memory.MLMemoryGetResponse;
...
public class TransportGetMemoryAction extends HandledTransportAction<ActionRequest, MLMemoryGetResponse> {
    ...
    protected void doExecute(Task task, ActionRequest request, ActionListener<MLMemoryGetResponse> actionListener) {
        ...
        client.execute(MLMemoryContainerGetAction.INSTANCE, containerRequest, ActionListener.wrap(containerResponse -> {
            ...
            getMemoryFromContainer(containerResponse.getMlMemoryContainer(), memoryId, actionListener);
